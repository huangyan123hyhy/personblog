        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://picsum.photos/seed/dev/100/100')",
              }}
            />
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <p className="text-sm text-slate-400">
            © 2024 个人作品集. 基于 Tailwind CSS 4 构建
          </p>
        </div>
      </div>
    </footer>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl">
              专注于构建高性能、可扩展的现代化 Web 应用。深耕 TypeScript, React,
              Node.js 以及云原生架构十余载，致力于通过技术解决商业难题。
            </p>
            <div className="flex flex-wrap gap-4 pt-4">
              <Link
                to="/projects"
                className="bg-primary text-white px-8 py-3 rounded-lg font-bold flex items-center gap-2 hover:translate-y-[-2px] transition-all"
              >
                查看作品集 <ArrowRight size={20} />
              </Link>
              <Link
                to="/blog"
                className="bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 px-8 py-3 rounded-lg font-bold border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
              >
                阅读博客
              </Link>
            </div>
      ...
      <section className="py-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button className="px-4 py-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700">
              技术分享
            </button>
            <button className="px-4 py-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700">
              项目经验
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article) => (
            <article
              key={article.id}
              className="flex flex-col bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl transition-shadow group"
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <Link
                  ...
                  className="text-primary dark:text-slate-200 font-bold text-sm inline-flex items-center gap-1 group/link"
                >
                  阅读全文{' '}
                  <ChevronRight
                    size={16}
        ...
        <div className="bg-primary rounded-[2rem] p-8 md:p-16 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center gap-6">
            ...
            <p className="text-slate-300 text-lg">
              无论你是想要交流技术，还是有极具挑战性的项目需要合作，我都非常期待与你沟通。
            </p>
            <div className="flex flex-wrap justify-center gap-4 mt-4">
              <Link
                to="/contact"
                className="bg-white text-primary px-10 py-4 rounded-xl font-black hover:bg-slate-100 transition-all flex items-center gap-2"
              >
                <Mail size={20} /> 发送邮件
              </Link>
    ...
    >
      <div className="mb-12">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-lg">
          在这里我分享关于前端开发、人工智能、后端架构以及 DevOps
          的深度见解和实践经验。
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    >
      <article className="flex-1 max-w-4xl">
          ...
          <div className="flex flex-wrap items-center gap-6 text-slate-400 text-sm">
            <div className="flex items-center gap-2">
              <img
                ...
                src="https://picsum.photos/seed/alex/50/50"
                referrerPolicy="no-referrer"
              />
        ...
        <div className="mt-12 flex gap-2">
          <span className="bg-primary/50 text-slate-400 px-3 py-1 rounded-full text-xs hover:text-white cursor-pointer">
            # React
          </span>
          <span className="bg-primary/50 text-slate-400 px-3 py-1 rounded-full text-xs hover:text-white cursor-pointer">
            # 性能优化
        ...
        <div className="sticky top-28 space-y-8">
          <div>
            ...
            <ul className="space-y-4 border-l border-primary/30 ml-2">
              <li>
                <a
                  className="block pl-4 py-1 text-slate-400 hover:text-accent border-l-2 border-transparent hover:border-accent -ml-[1px] transition-all text-sm"
                  href="#"
                >
                  核心概念
                </a>
          ...
          <div className="bg-primary/20 p-6 rounded-2xl border border-primary/30">
            ...
            <p className="text-xs text-slate-400 mb-4 leading-relaxed">
              获取最新的技术动态与深度好文，每周准时推送。
            </p>
            <div className="flex flex-col gap-2">
              <input
                className="bg-background-dark border-primary/50 rounded-lg px-3 py-2 text-sm focus:ring-accent focus:border-accent text-white"
                placeholder="你的邮箱"
                type="email"
              />
              <button className="bg-accent text-white text-sm font-bold py-2 rounded-lg hover:bg-blue-600 transition-colors">
                订阅
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 font-medium">
            你好，我是 Alex。一名拥有 10 年经验的全栈工程师，目前专注于 AI
            应用开发与高性能架构。
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span
                key={skill}
                className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-sm font-bold border border-slate-200 dark:border-slate-700"
              >
                {skill}
              </span>
            ))}
          ...
          <div className="space-y-6 border-l-2 border-slate-200 dark:border-slate-800 ml-3 pl-6">
            <div className="relative">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 mt-2">
                负责核心交易系统的重构与性能优化，支撑了双十一期间百万级并发。
              </p>
            </div>
            <div className="relative">
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                color: 'slate',
                label: 'GitHub',
                value: 'github.com/alex-fullstack',
              },
            ].map(({ icon: Icon, color, label, value }) => (
              <div
                key={label}
                className="flex items-center gap-4 p-4 rounded-2xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm"
              >
                <div
                  className={`size-12 rounded-xl bg-${color}-500/10 text-${color}-500 flex items-center justify-center`}
                >
                  <Icon size={24} />
                </div>
                <div>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      required
                      className="w-full bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 focus:ring-2 focus:ring-accent/20 outline-none transition-all"
                      placeholder="你的名字"
                      value={form.name}
                      onChange={(e) =>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    required
                    rows={5}
                    className="w-full bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 focus:ring-2 focus:ring-accent/20 outline-none transition-all resize-none"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-primary text-white font-black py-4 rounded-xl hover:bg-primary/90 transition-all flex items-center justify-center gap-2 disabled:opacity-60"
                >
                  {loading ? (
                    '发送中...'
                  ) : (
                    <>
                      <span>发送消息</span> <ArrowRight size={20} />
                    </>
                  )}
                </button>
              </motion.form>
  ...
  const projects = [
    {
      ...
      title: '智能投顾 AI 助手',
      description:
        '基于 LLM 的金融问答系统，支持实时行情分析与个性化资产配置建议。',
    ...
    },
    {
      ...
      title: '分布式电商秒杀系统',
      description:
        '应对高并发场景的电商解决方案，采用 Redis 队列与数据库读写分离架构。',
    ...
    },
    {
      ...
      title: '跨平台健康管理 App',
      description:
        '使用 React Native 开发的健康追踪应用，集成硬件传感器数据实时同步。',
  ...
  return (
    ...
    >
      <div className="mb-12">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-lg">
          精选我在过去几年中主导或核心参与的代表性项目。
        </p>
      </div>
      <div className="flex gap-4 mb-12 overflow-x-auto pb-2">
        {['全部', 'AI 算法', 'Web 开发', '移动端', '架构设计'].map(
          (filter, i) => (
            <button
              key={i}
              className={cn(
                ...
                i === 0
                  ...
                  : 'bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700',
              )}
            >
              {filter}
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project) => (
          <div
            key={project.id}
            className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm group"
          >
            <div className="aspect-video relative overflow-hidden">
              <img
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
            ...
            <div className="p-6">
              <div className="flex gap-2 mb-3">
                {project.tags.map((tag, i) => (
                  <span
                    key={i}
                    className="text-[10px] font-bold px-2 py-0.5 rounded bg-blue-500/10 text-blue-500 uppercase tracking-wider"
                  >
                    {tag}
                  </span>
                ))}
      ...
      <aside className="w-64 bg-[#0f172a] border-r border-slate-800 flex flex-col shrink-0">
        ...
        <nav className="flex-1 px-4 space-y-1 mt-4">
          ...
          <div className="pt-4 mt-4 border-t border-slate-800">
            <Link
              to="/"
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-colors group"
            >
        ...
        <header className="h-16 border-b border-slate-800 bg-background-dark/50 backdrop-blur-md flex items-center justify-between px-8 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="relative group hidden md:block">
              ...
              />
              <input
                className="pl-10 pr-4 py-1.5 rounded-lg bg-slate-900 border-none text-sm w-64 focus:ring-2 focus:ring-blue-500/20 text-slate-200"
                placeholder="搜索文章..."
                type="text"
              />
            </div>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div
            key={label}
            className="p-6 rounded-xl bg-[#111827] border border-slate-800 shadow-sm"
          >
            <div className="flex items-center justify-between mb-4">
              <div
                className={`p-2 bg-${color}-500/10 text-${color}-500 rounded-lg`}
              >
                <Icon size={24} />
              </div>
              <span
                className={`text-${badgeColor}-500 text-xs font-bold bg-${badgeColor}-500/10 px-2 py-1 rounded-full`}
              >
                {badge}
              </span>
            </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-slate-800 flex-shrink-0 overflow-hidden">
                        <img
                          className="w-full h-full object-cover"
                          src={`https://picsum.photos/seed/${article.slug}/50/50`}
                          referrerPolicy="no-referrer"
                        />
                      </div>
    ...
    <div className="space-y-6">
        ...
        <div className="p-6 bg-[#111827] border border-blue-500/30 rounded-xl space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input
                className="w-full bg-slate-900 border-slate-800 rounded-lg px-3 py-2 text-white text-sm outline-none focus:ring-2 focus:ring-blue-500/20"
                placeholder="分类名称"
                value={form.name}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {categories.map((category) => (
          <div
            key={category.id}
            className="p-6 rounded-xl bg-[#111827] border border-slate-800 shadow-sm group"
          >
            <div className="flex items-center justify-between mb-4">
...
const AdminSettings = () => {
  const [settings, setSettings] = useState({
    ...
    subtitle: '资深全栈工程师作品集',
    description:
      '一个集成了个人作品展示、技术博客、项目案例及后台管理系统的全栈工程师作品集应用。',
    github: '',
    wechat: '',
  })
  const [saving, setSaving] = useState(false)
      ...
      <div className="space-y-6">
        <div className="p-8 rounded-2xl bg-[#111827] border border-slate-800 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                className="w-full bg-slate-900 border-slate-800 rounded-xl px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/20 outline-none"
                value={settings.blog_name}
                onChange={(e) =>
                  setSettings({ ...settings, blog_name: e.target.value })
                }
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <textarea
              rows={3}
              className="w-full bg-slate-900 border-slate-800 rounded-xl px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/20 outline-none resize-none"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setSettings({ ...settings, wechat: e.target.value })
                }
              />
            </div>
          </div>
        ...
        <div className="flex justify-end gap-4 items-center">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-slate-800 text-slate-300 font-bold hover:bg-slate-700 transition-all"
          >
            重置
          </button>
          <button
            onClick={handleSave}
            disabled={saving}
            className="px-8 py-2.5 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 transition-all disabled:opacity-50"
          >
            {saving ? '保存中...' : '保存更改'}
          </button>
        </div>
